{
  ...
  "repository": {
    "type": "git",
    "url": "https://github.com/fdebrus/bmw-cardata-info-card",
    "repo": "fdebrus/bmw-cardata-info-card"
  },
  "main": "bmw-cardata-info-card.js",
  "license": "MIT",
  "dependencies": {
    "@mdi/js": "^7.4.47",
    "apexcharts": "^5.3.3",
  ...
  "scripts": {
    ...
    "build": "pnpm run import-lang && pnpm run lint && pnpm run rollup",
    ...
    "debug": "cross-env DEBUG=true pnpm start"
  }
}
